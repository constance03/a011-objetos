...
console.log("copia dos pokemons: ", pokemon1Copia);

// b) No objeto original, adicione mais uma propriedade, chamada ataques (array de objetos).
...
console.log("ataques no pokemon original: ", pokemon1);
...
console.log("ataques no pokemon copia: ", pokemon1Copia);
...
console.log("objeto original pós modificações: ", pokemon1);
console.log("cópia do objeto pós modificações: ", pokemon1Copia);